\subsection{Second-order M\o ller-Plesset Theory: MP2 and MP2-R12 methods} \label{cc}
...
%In the context of approaches to obtain {\em ab initio}
%limit results, the MP2 method is used to recover basis set incompleteness
%correction. A promising approach to reduce basis set
%incompleteness is to include {\em explicit}
%electron correlation via terms linear in the interelectronic distances.
%The so-called linear R12 methods of Kutzelnigg
