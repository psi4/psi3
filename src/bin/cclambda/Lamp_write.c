...
void Lamp_write(struct L_Params L_params) {
  ...
  if(params.ref == 0) { /** RHF **/
    dpd_file2_init(&L1, CC_LAMBDA, 0, 0, 1, "LIA");
    amp_write_L1(&L1, params.num_amps, "\n\tLargest LIA Amplitudes:\n", outfile);
    dpd_file2_close(&L1);

    dpd_buf4_init(&L2, CC_LAMBDA, 0, 0, 5, 0, 5, 0, "LIjAb");
    ...
    dpd_buf4_init(&L2, CC_LAMBDA, 0, 2, 7, 2, 7, 0, "LIJAB");
    amp_write_L2(&L2, params.num_amps, "\n\tLargest LIJAB Amplitudes:\n", outfile);
    dpd_buf4_close(&L2);
    dpd_buf4_init(&L2, CC_LAMBDA, 0, 2, 7, 2, 7, 0, "Lijab");
    amp_write_L2(&L2, params.num_amps, "\n\tLargest Lijab Amplitudes:\n", outfile);
    ...
    amp_write_L1(&L1, params.num_amps, "\n\tLargest LIA Amplitudes:\n", outfile);
    dpd_file2_close(&L1);
    dpd_file2_init(&L1, CC_LAMBDA, 0, 2, 3, "Lia");
    amp_write_L1(&L1, params.num_amps, "\n\tLargest Lia Amplitudes:\n", outfile);
    dpd_file2_close(&L1);
    ...
    amp_write_L2(&L2, params.num_amps, "\n\tLargest LIJAB Amplitudes:\n", outfile);
    dpd_buf4_close(&L2);
    dpd_buf4_init(&L2, CC_LAMBDA, 0, 12, 17, 12, 17, 0, "Lijab");
    amp_write_L2(&L2, params.num_amps, "\n\tLargest Lijab Amplitudes:\n", outfile);
    dpd_buf4_close(&L2);
    dpd_buf4_init(&L2, CC_LAMBDA, 0, 22, 28, 22, 28, 0, "LIjAb");
    amp_write_L2(&L2, params.num_amps, "\n\tLargest LIjAb Amplitudes:\n", outfile);
    dpd_buf4_close(&L2);
  }
}
