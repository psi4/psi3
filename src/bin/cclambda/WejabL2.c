...
void WejabL2(void)
{
  ...
  if(params.ref == 0 || params.ref == 1) { /** RHF/ROHF **/
    ...
    */
    ...
    dpd_buf4_init(&Z, CC_TMP1, 0, 0, 7, 0, 7, 0, "Z(IJ,AB)");
    ...
    dpd_buf4_init(&Z1, CC_TMP1, 0, 0, 7, 0, 7, 0, "Z(IJ,AB)");
    dpd_buf4_init(&Z2, CC_TMP1, 0, 0, 7, 0, 7, 0, "Z(JI,AB)");
    ...
    /** Z(ij,ab) = L(i,e) W(ej,ab) **/
    dpd_buf4_init(&Z, CC_TMP1, 0, 10, 17, 10, 17, 0, "Z(ij,ab)");
    ...
    dpd_buf4_close(&Z);
    /** Z(ij,ab) = Z(ij,ab) - Z(ji,ab) **/
    dpd_buf4_init(&Z1, CC_TMP1, 0, 10, 17, 10, 17, 0, "Z(ij,ab)");
    dpd_buf4_init(&Z2, CC_TMP1, 0, 10, 17, 10, 17, 0, "Z(ji,ab)");
    dpd_buf4_axpy(&Z2, &Z1, -1);
    dpd_buf4_close(&Z2);
    /** Z(ij,ab) --> New L(ij,ab) **/
