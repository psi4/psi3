...
void WmbejL2(void)
{
  ...
  if(params.ref == 0 || params.ref == 1) { /** RHF/ROHF **/
    ...
    dpd_buf4_init(&newL2, CC_LAMPS, L_irr, 0, 5, 2, 7, 0, "New LIJAB");
    ...
    dpd_buf4_init(&L2, CC_LAMPS, L_irr, 10, 10, 10, 10, 0, "LIbjA");
    dpd_buf4_init(&W, CC_HBAR, 0, 10, 10, 10, 10, 0, "WMbeJ");
    dpd_contract444(&W, &L2, &Z, 0, 1, 1.0, 0.0);
    dpd_buf4_close(&L2);
    dpd_buf4_close(&W);
    dpd_buf4_init(&L2, CC_LAMPS, L_irr, 10, 10, 10, 10, 0, "LjAIb");
    dpd_buf4_init(&W, CC_HBAR, 0, 10, 10, 10, 10, 0, "WmBEj");
    ...
    dpd_buf4_init(&L2, CC_LAMPS, L_irr, 20, 20, 20, 20, 0, "LIAJB");
    ...
    dpd_buf4_init(&L2, CC_LAMPS, L_irr, 30, 30, 30, 30, 0, "Liajb");
    dpd_buf4_init(&W, CC_HBAR, 0, 30, 30, 30, 30, 0, "Wmbej");
    dpd_contract444(&L2, &W, &Z, 0, 0, 1, 0);
    dpd_buf4_close(&W);
    dpd_buf4_close(&L2);
    dpd_buf4_init(&L2, CC_LAMPS, L_irr, 30, 20, 30, 20, 0, "LiaJB");
    ...
    dpd_buf4_init(&newL2, CC_LAMPS, L_irr, 10, 15, 12, 17, 0, "New Lijab");
    dpd_buf4_axpy(&Z, &newL2, 1);
    dpd_buf4_close(&Z);
    dpd_buf4_close(&newL2);
    ...
    dpd_buf4_init(&L2, CC_LAMPS, L_irr, 24, 27, 24, 27, 0, "LIbjA");
    dpd_buf4_init(&W, CC_HBAR, 0, 24, 24, 24, 24, 0, "WMbeJ");
    dpd_contract444(&W, &L2, &Z, 0, 1, 1, 0);
    dpd_buf4_close(&L2);
    dpd_buf4_close(&W);
    dpd_buf4_init(&L2, CC_LAMPS, L_irr, 27, 24, 27, 24, 0, "LjAIb");
