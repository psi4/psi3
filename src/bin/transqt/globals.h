...
#define ERI 0                  /* ERIs - two-electron ints which have 8-fold permutational symmetry:
				  (pq|rs) = (pq|sr) = (qp|rs) = (qp|sr) = (rs|pq) = (sr|pq) =
				  (rs|qp) = (sr|qp)
				  */
#define R12 0                  /* integrals of r12 - have the same permutational symmetry as ERIs */
#define R12T1 1                /* integrals of [r12,T1] operator - have the following symmetry:
