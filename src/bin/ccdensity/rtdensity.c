...
void rtdensity(struct RHO_Params S)
{
  ...
  if(params.ref == 0 || params.ref == 1) { /** RHF/ROHF **/
    ...
    dpd_file2_init(&D, CC_TMP, S.L_irr, 0, 0, "RTDIJ");
    dpd_buf4_init(&T2, CC_TAMPS, 0, 0, 7, 2, 7, 0, "tIJAB");
    dpd_buf4_init(&L2, CC_GL, S.L_irr, 0, 7, 2, 7, 0, "LIJAB");
    ...
    dpd_file2_init(&L1, CC_GL, S.L_irr, 0, 1, "LIA");
    ...
    dpd_file2_init(&D, CC_TMP, S.L_irr, 1, 1, "RTDAB");
    dpd_buf4_init(&L2, CC_GL, S.L_irr, 2, 5, 2, 7, 0, "LIJAB");
    ...
    dpd_file2_init(&D, CC_TMP, S.L_irr, 0, 1, "RTDIA");
    ...
    dpd_file2_init(&L1, CC_GL, S.L_irr, 0, 1, "LIA");
    dpd_file2_init(&T1, CC_OEI, 0, 0, 1, "tIA");
    dpd_file2_init(&Z, CC_TMP0, S.L_irr, 0, 0, "Z(I,M)");
    ...
    dpd_file2_init(&Z, CC_TMP0, S.L_irr, 1, 1, "Z(A,E)");
    dpd_buf4_init(&T2, CC_TAMPS, 0, 2, 5, 2, 7, 0, "tIJAB");
    dpd_buf4_init(&L2, CC_GL, S.L_irr, 2, 5, 2, 7, 0, "LIJAB");
    ...
    dpd_file2_init(&D, CC_TMP, 0, 0, 0, "RTDIJ");
    dpd_buf4_init(&T2, CC_TAMPS, 0, 0, 7, 2, 7, 0, "tIJAB");
    dpd_buf4_init(&L2, CC_GL, S.L_irr, 0, 7, 2, 7, 0, "LIJAB");
    dpd_contract442(&T2, &L2, &D, 0, 0, -1.0, 0.0);
    dpd_buf4_close(&L2);
    ...
    dpd_file2_init(&D, CC_TMP, 0, 2, 2, "RTDij");
    dpd_buf4_init(&T2, CC_TAMPS, 0, 10, 17, 12, 17, 0, "tijab");
    dpd_buf4_init(&L2, CC_GL, S.L_irr, 10, 17, 12, 17, 0, "Lijab");
    dpd_contract442(&T2, &L2, &D, 0, 0, -1.0, 0.0);
    dpd_buf4_close(&L2);
    dpd_buf4_close(&T2);
    ...
    dpd_file2_init(&L1, CC_GL, S.L_irr, 2, 3, "Lia");
    dpd_contract222(&T1, &L1, &D, 0, 0, -1.0, 1.0);
    dpd_file2_close(&L1);
    dpd_file2_close(&T1);
    dpd_file2_close(&D);

    dpd_file2_init(&D, CC_TMP, 0, 1, 1, "RTDAB");
    dpd_buf4_init(&L2, CC_GL, S.L_irr, 2, 5, 2, 7, 0, "LIJAB");
    dpd_buf4_init(&T2, CC_TAMPS, 0, 2, 5, 2, 7, 0, "tIJAB");
    dpd_contract442(&L2, &T2, &D, 3, 3, 1.0, 0.0);
    dpd_buf4_close(&T2);
    ...
    dpd_file2_init(&D, CC_TMP, 0, 3, 3, "RTDab");
    dpd_buf4_init(&L2, CC_GL, S.L_irr, 12, 15, 12, 17, 0, "Lijab");
    ...
    dpd_file2_init(&D, CC_TMP, 0, 0, 1, "RTDIA");
    ...
    dpd_file2_init(&D, CC_TMP, 0, 2, 3, "RTDia");
