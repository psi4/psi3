...
void V_build_x(void)
{
  ...
  if(params.ref == 0 || params.ref == 1) { /** RHF/ROHF **/
    ...
    dpd_buf4_init(&V, EOM_TMP, 0, 2, 2, 2, 2, 0, "VMNIJ");
    ...
    dpd_buf4_init(&V, EOM_TMP, 0, 0, 0, 0, 0, 0, "VMnIj");
    ...
    dpd_buf4_init(&V, EOM_TMP, 0, 10, 10, 10, 10, 0, "VIAJB");
    ...
    dpd_buf4_init(&V, EOM_TMP, 0, 12, 12, 12, 12, 0, "Vmnij");
    ...
    dpd_buf4_init(&V, EOM_TMP, 0, 22, 22, 22, 22, 0, "VMnIj");
    ...
    dpd_buf4_init(&V, EOM_TMP, 0, 20, 20, 20, 20, 0, "VIAJB");
    ...
    dpd_buf4_init(&V, EOM_TMP, 0, 30, 30, 30, 30, 0, "Viajb");
    ...
    dpd_buf4_init(&V, EOM_TMP, 0, 20, 30, 20, 30, 0, "VIAjb");
    dpd_buf4_init(&T, CC_TAMPS, 0, 20, 30, 20, 30, 0, "tIAjb");
    dpd_buf4_init(&L, CC_GL, L_irr, 30, 30, 30, 30, 0, "Liajb");
    dpd_contract444(&T, &L, &V, 0, 0, 1.0, 0.0);
    dpd_buf4_close(&L);
    ...
    dpd_buf4_init(&V, EOM_TMP, 0, 30, 20, 30, 20, 0, "ViaJB");
    ...
    dpd_buf4_init(&V, EOM_TMP, 0, 27, 27, 27, 27, 0, "ViAjB");
    ...
    dpd_buf4_init(&V, EOM_TMP, 0, 24, 24, 24, 24, 0, "VIaJb");
