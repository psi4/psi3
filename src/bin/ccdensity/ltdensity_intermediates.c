...
void ltdensity_intermediates(struct RHO_Params S)
{
  ...
  /* LR1_OO(I,J)  =  LIE * RJE */
  dpd_file2_init(&I, EOM_TMP, S.G_irr, 0, 0, "LR1_OO");
  dpd_file2_init(&L1, CC_GLG, 0, 0, 1, "LIA");
  dpd_file2_init(&R1, CC_GR, S.R_irr, 0, 1, "RIA");
  ...
  if (rohf) {
    ...
    dpd_file2_init(&I, EOM_TMP, S.G_irr, 2, 2, "LR1_oo");
    dpd_file2_init(&L1, CC_GLG, 0, 2, 3, "Lia");
    dpd_file2_init(&R1, CC_GR, S.R_irr, 2, 3, "Ria");
    dpd_contract222(&L1, &R1, &I, 0, 0, 1.0, 0.0);
    dpd_file2_close(&R1);
    dpd_file2_close(&L1);
    dpd_file2_close(&I);
  ...
  dpd_file2_init(&I, EOM_TMP, S.G_irr, 1, 1, "LR1_VV");
  dpd_file2_init(&L1, CC_GLG, 0, 0, 1, "LIA");
  dpd_file2_init(&R1, CC_GR, S.R_irr, 0, 1, "RIA");
  ...
  if (rohf) {
    ...
    dpd_file2_init(&I, EOM_TMP, S.G_irr, 3, 3, "LR1_vv");
    dpd_file2_init(&L1, CC_GLG, 0, 2, 3, "Lia");
    dpd_file2_init(&R1, CC_GR, S.R_irr, 2, 3, "Ria");
    dpd_contract222(&L1, &R1, &I, 1, 1, 1.0, 0.0);
    dpd_file2_close(&R1);
  ...
  if (rohf) {
    dpd_file2_init(&I, EOM_TMP, S.G_irr, 0, 1, "L2R1_OV");
  ...
  if (rohf) {
    ...
    dpd_file2_init(&I, EOM_TMP, S.G_irr, 2, 3, "L2R1_ov");
  ...
  if (rohf) {
    dpd_file2_init(&I, EOM_TMP, S.G_irr, 0, 1, "L1R2_OV");
    dpd_buf4_init(&R2, CC_GR, S.R_irr, 0, 5, 2, 7, 0, "RIJAB");
    dpd_file2_init(&L1, CC_GLG, 0, 0, 1, "LIA");
    dpd_dot24(&L1, &R2, &I, 0, 0, 1.0, 0.0);
    dpd_file2_close(&L1);
    dpd_buf4_close(&R2);
    dpd_buf4_init(&R2, CC_GR, S.R_irr, 0, 5, 0, 5, 0, "RIjAb");
    dpd_file2_init(&L1, CC_GLG, 0, 0, 1, "Lia");
    ...
    dpd_file2_close(&L1);
    dpd_buf4_close(&R2);
    dpd_buf4_init(&R2, CC_GR, S.R_irr, 22, 28, 22, 28, 0, "RIjAb");
    dpd_file2_init(&L1, CC_GLG, 0, 2, 3, "Lia");
    dpd_dot24(&L1, &R2, &I, 0, 0, 1.0, 1.0);
    dpd_file2_close(&L1);
    dpd_buf4_close(&R2);
  ...
  if (rohf) {
    ...
    dpd_file2_init(&I, EOM_TMP, S.G_irr, 2, 3, "L1R2_ov");
    dpd_buf4_init(&R2, CC_GR, S.R_irr, 10, 15, 12, 17, 0, "Rijab");
    dpd_file2_init(&L1, CC_GLG, 0, 2, 3, "Lia");
    dpd_dot24(&L1, &R2, &I, 0, 0, 1.0, 0.0);
    dpd_file2_close(&L1);
    dpd_buf4_close(&R2);
    dpd_buf4_init(&R2, CC_GR, S.R_irr, 23, 29, 23, 29, 0, "RiJaB");
    dpd_file2_init(&L1, CC_GLG, 0, 0, 1, "LIA");
    dpd_dot24(&L1, &R2, &I, 0, 0, 1.0, 1.0);
    dpd_file2_close(&L1);
    dpd_buf4_close(&R2);
  ...
  if (rohf) {
    dpd_file2_init(&I, EOM_TMP, S.G_irr, 0, 0, "LR2_OO");
    dpd_buf4_init(&L2, CC_GLG, 0, 0, 7, 2, 7, 0, "LIJAB");
    dpd_buf4_init(&R2, CC_GR, S.R_irr, 0, 7, 2, 7, 0, "RIJAB");
  ...
  if (rohf) {
    ...
    dpd_file2_init(&I, EOM_TMP, S.G_irr, 2, 2, "LR2_oo");
    dpd_buf4_init(&L2, CC_GLG, 0, 10, 17, 12, 17, 0, "Lijab");
    dpd_buf4_init(&R2, CC_GR, S.R_irr, 10, 17, 12, 17, 0, "Rijab");
    dpd_contract442(&L2, &R2, &I, 0, 0, 1.0, 0.0);
    dpd_buf4_close(&R2);
    dpd_buf4_close(&L2);
    dpd_buf4_init(&L2, CC_GLG, 0, 23, 29, 23, 29, 0, "LiJaB");
  ...
  if (rohf) {
    dpd_file2_init(&I, EOM_TMP, S.G_irr, 1, 1, "LR2_VV");
    dpd_buf4_init(&L2, CC_GLG, 0, 2, 5, 2, 7, 0, "LIJAB");
    dpd_buf4_init(&R2, CC_GR, S.R_irr, 2, 5, 2, 7, 0, "RIJAB");
  ...
  if (rohf) {
    ...
    dpd_file2_init(&I, EOM_TMP, S.G_irr, 3, 3, "LR2_vv");
    dpd_buf4_init(&L2, CC_GLG, 0, 12, 15, 12, 17, 0, "Lijab");
    dpd_buf4_init(&R2, CC_GR, S.R_irr, 12, 15, 12, 17, 0, "Rijab");
    dpd_contract442(&L2, &R2, &I, 3, 3, 1.0, 0.0);
    dpd_buf4_close(&R2);
    dpd_buf4_close(&L2);
    dpd_buf4_init(&L2, CC_GLG, 0, 22, 28, 22, 28, 0, "LIjAb");
  ...
  dpd_file2_init(&I, EOM_TMP, S.G_irr, 0, 0, "LR_OO");
  dpd_file2_init(&LR1, EOM_TMP, S.G_irr, 0, 0, "LR1_OO");
  dpd_file2_init(&LR2, EOM_TMP, S.G_irr, 0, 0, "LR2_OO");
  ...
  if (rohf) {
    ...
    dpd_file2_init(&I, EOM_TMP, S.G_irr, 2, 2, "LR_oo");
    dpd_file2_init(&LR1, EOM_TMP, S.G_irr, 2, 2, "LR1_oo");
    dpd_file2_init(&LR2, EOM_TMP, S.G_irr, 2, 2, "LR2_oo");
    dpd_file2_axpbycz(&LR1, &LR2, &I, 1.0, 1.0, 0.0);
    dpd_file2_close(&LR2);
    dpd_file2_close(&LR1);
    dpd_file2_close(&I);
  ...
  dpd_file2_init(&I, EOM_TMP, S.G_irr, 1, 1, "LR_VV");
  dpd_file2_init(&LR1, EOM_TMP, S.G_irr, 1, 1, "LR1_VV");
  dpd_file2_init(&LR2, EOM_TMP, S.G_irr, 1, 1, "LR2_VV");
  dpd_file2_axpbycz(&LR1, &LR2, &I, 1.0, 1.0, 0.0);
  dpd_file2_close(&LR2);
  dpd_file2_close(&LR1);
  dpd_file2_close(&I);
  ...
  if (rohf) {
    ...
    dpd_file2_init(&I, EOM_TMP, S.G_irr, 3, 3, "LR_vv");
    dpd_file2_init(&LR1, EOM_TMP, S.G_irr, 3, 3, "LR1_vv");
    dpd_file2_init(&LR2, EOM_TMP, S.G_irr, 3, 3, "LR2_vv");
    dpd_file2_axpbycz(&LR1, &LR2, &I, 1.0, 1.0, 0.0);
    dpd_file2_close(&LR2);
    dpd_file2_close(&LR1);
    dpd_file2_close(&I);
