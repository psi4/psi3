...
void td_setup(struct RHO_Params S)
{
  ...
  if((params.ref==0) || (params.ref==1)) {
    dpd_file2_init(&L1, CC_LAMPS, S.L_irr, 0, 1, S.L1A_lbl);
    dpd_file2_copy(&L1, CC_GL, "LIA");
    dpd_file2_close(&L1);

    dpd_file2_init(&L1, CC_LAMPS, S.L_irr, 0, 11, S.L1B_lbl);
    dpd_file2_copy(&L1, CC_GL, "Lia");
    dpd_file2_close(&L1);

    dpd_buf4_init(&L2, CC_LAMPS, S.L_irr, 2, 7, 2, 7, 0, S.L2AA_lbl);
    dpd_buf4_copy(&L2, CC_GL, "LIJAB");
    dpd_buf4_close(&L2);

    dpd_buf4_init(&L2, CC_LAMPS, S.L_irr, 2, 7, 2, 7, 0, S.L2BB_lbl);
    dpd_buf4_copy(&L2, CC_GL, "Lijab");
    dpd_buf4_close(&L2);

    dpd_buf4_init(&L2, CC_LAMPS, S.L_irr, 0, 5, 0, 5, 0, S.L2AB_lbl);
    dpd_buf4_copy(&L2, CC_GL, "LIjAb");
    dpd_buf4_close(&L2);
  }
  else if (params.ref == 2) {
    ...
    dpd_file2_init(&L1, CC_LAMPS, S.L_irr, 2, 3, S.L1B_lbl);
    dpd_file2_copy(&L1, CC_GL, "Lia");
    dpd_file2_close(&L1);
    ...
    dpd_buf4_init(&L2, CC_LAMPS, S.L_irr, 12, 17, 12, 17, 0, S.L2BB_lbl);
    dpd_buf4_copy(&L2, CC_GL, "Lijab");
    dpd_buf4_close(&L2);

    dpd_buf4_init(&L2, CC_LAMPS, S.L_irr, 22, 28, 22, 28, 0, S.L2AB_lbl);
    dpd_buf4_copy(&L2, CC_GL, "LIjAb");
    dpd_buf4_close(&L2);
  }

  if((params.ref == 0) || (params.ref == 1)) {
    dpd_file2_init(&R1, CC_RAMPS, S.R_irr, 0, 1, S.R1A_lbl);
    dpd_file2_copy(&R1, CC_GR, "RIA");
    dpd_file2_close(&R1);

    dpd_file2_init(&R1, CC_RAMPS, S.R_irr, 0, 1, S.R1B_lbl);
    dpd_file2_copy(&R1, CC_GR, "Ria");
    dpd_file2_close(&R1);

    dpd_buf4_init(&R2, CC_RAMPS, S.R_irr, 2, 7, 2, 7, 0, S.R2AA_lbl);
    dpd_buf4_copy(&R2, CC_GR, "RIJAB");
    dpd_buf4_close(&R2);

    dpd_buf4_init(&R2, CC_RAMPS, S.R_irr, 2, 7, 2, 7, 0, S.R2BB_lbl);
    dpd_buf4_copy(&R2, CC_GR, "Rijab");
    dpd_buf4_close(&R2);

    dpd_buf4_init(&R2, CC_RAMPS, S.R_irr, 0, 5, 0, 5, 0, S.R2AB_lbl);
    dpd_buf4_copy(&R2, CC_GR, "RIjAb");
    dpd_buf4_close(&R2);
  }
  else if (params.ref == 2) {
    ...
    dpd_file2_init(&R1, CC_RAMPS, S.R_irr, 2, 3, S.R1B_lbl);
    dpd_file2_copy(&R1, CC_GR, "Ria");
    dpd_file2_close(&R1);
    ...
    dpd_buf4_init(&R2, CC_RAMPS, S.R_irr, 12, 17, 12, 17, 0, S.R2BB_lbl);
    dpd_buf4_copy(&R2, CC_GR, "Rijab");
    dpd_buf4_close(&R2);

    dpd_buf4_init(&R2, CC_RAMPS, S.R_irr, 22, 28, 22, 28, 0, S.R2AB_lbl);
    dpd_buf4_copy(&R2, CC_GR, "RIjAb");
    dpd_buf4_close(&R2);
  }
  ...
  if((params.ref==0) || (params.ref==1)) { /** RHF/ROHF **/
    ...
    dpd_buf4_init(&L2, CC_GL, S.L_irr, 10, 10, 10, 10, 0, "LIAjb");
    dpd_buf4_sort(&L2, CC_GL, psrq, 10, 10, "LIbjA");
    dpd_buf4_sort(&L2, CC_GL, rqps, 10, 10, "LjAIb");
    dpd_buf4_close(&L2);
  }
  else if(params.ref == 2) { /** UHF **/
    dpd_buf4_init(&L2, CC_GL, S.L_irr, 22, 28, 22, 28, 0, "LIjAb");
    ...
    dpd_buf4_init(&L2, CC_GL, S.L_irr, 10, 15, 12, 17, 0, "Lijab");
    ...
    dpd_buf4_init(&L2, CC_GL, S.L_irr, 23, 29, 23, 29, 0, "LiJaB");
    dpd_buf4_sort(&L2, CC_GL, prqs, 30, 20, "LiaJB");
    dpd_buf4_close(&L2);
  
    dpd_buf4_init(&L2, CC_GL, S.L_irr, 20, 30, 20, 30, 0, "LIAjb");
  ...
  if((params.ref==0) || (params.ref==1)) { /** RHF/ROHF **/
    ...
    dpd_buf4_init(&R2, CC_GR, S.R_irr, 10, 10, 10, 10, 0, "RIAjb");
    ...
    dpd_buf4_init(&R2, CC_GR, S.R_irr, 20, 30, 20, 30, 0, "RIAjb");
