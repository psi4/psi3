...
/*   dpd_buf4_close(&Bmat); */
  ...
  dpd_buf4_sort(&D, PSIF_MO_HESS, sprq, 11, 11, "B(AI,BJ) triplet");
  dpd_buf4_close(&D);

  dpd_buf4_init(&C, CC_CINTS, 0, 10, 10, 10, 10, 0, "C <ia|jb>");
  dpd_buf4_sort_axpy(&C, PSIF_MO_HESS, qpsr, 11, 11, "B(AI,BJ)", -1);
  dpd_buf4_sort_axpy(&C, PSIF_MO_HESS, qpsr, 11, 11, "B(AI,BJ) triplet", -1);
  dpd_buf4_close(&C);

/*   dpd_buf4_init(&Bmat, PSIF_MO_HESS, 0, 11, 11, 11, 11, 0, "B(AI,BJ) triplet"); */
/*   dpd_buf4_scm(&Bmat, -1); */
/*   dpd_buf4_close(&Bmat); */
