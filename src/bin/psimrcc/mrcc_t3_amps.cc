        ...
        if((i!=j) && (j!=k) && (i!=k)){
          for(int abc = 0;abc<MatTmp->get_right_pairpi(h);abc++){
            ...
            if((a!=b) && (b!=c) && (a!=c)){
              ...
              rel_left   = TijabMatTmp->get_left()->get_tuple_index(i,j,a);
              vec_length = TijabMatTmp->get_right_pairpi(sym_left);
              sym_right  = WabicMatTmp->get_left()->get_tuple_irrep(b,c,k);
              rel_right  = WabicMatTmp->get_left()->get_tuple_index(b,c,k);
              if(vec_length>0){
              ...
              rel_left  = TiabjMatTmp->get_left()->get_tuple_index(i,a,b);
              vec_length= TiabjMatTmp->get_right_pairpi(sym_left);
              sym_right = WajkiMatTmp->get_left()->get_tuple_irrep(c,j,k);
              rel_right = WajkiMatTmp->get_left()->get_tuple_index(c,j,k);
              if(vec_length>0){
        ...
        if(i!=j){
          for(int abc = 0;abc<MatTmp->get_right_pairpi(h);abc++){
            ...
            if(a!=b){
              ...
              rel_left   = TJiBaMatTmp->get_left()->get_tuple_index(K,j,C);
              vec_length = TJiBaMatTmp->get_right_pairpi(sym_left);
              sym_right  = WabicMatTmp->get_left()->get_tuple_irrep(b,a,i);
              rel_right  = WabicMatTmp->get_left()->get_tuple_index(b,a,i);
              if(vec_length>0){
              ...
              rel_left   = TiJaBMatTmp->get_left()->get_tuple_index(j,K,a);
              vec_length = TiJaBMatTmp->get_right_pairpi(sym_left);
              sym_right  = WAbiCMatTmp->get_left()->get_tuple_irrep(C,b,i);
              rel_right  = WAbiCMatTmp->get_left()->get_tuple_index(C,b,i);
              if(vec_length>0){
                value = F_DDOT(&vec_length,&(TiJaB_matrix[sym_left][rel_left][0]),&incx,&(WAbiC_matrix[sym_right][rel_right][0]),&incy);
              ...
              rel_left  = TJaBiMatTmp->get_left()->get_tuple_index(K,b,C);
              vec_length= TJaBiMatTmp->get_right_pairpi(sym_left);
              sym_right = WajkiMatTmp->get_left()->get_tuple_irrep(a,j,i);
              rel_right = WajkiMatTmp->get_left()->get_tuple_index(a,j,i);
              if(vec_length>0){
              ...
              rel_left  = TiBaJMatTmp->get_left()->get_tuple_index(j,C,a);
              vec_length= TiBaJMatTmp->get_right_pairpi(sym_left);
              sym_right = WaJkIMatTmp->get_left()->get_tuple_irrep(b,K,i);
              rel_right = WaJkIMatTmp->get_left()->get_tuple_index(b,K,i);
              if(vec_length>0){
        ...
        if(J!=K){
          for(int abc = 0;abc<MatTmp->get_right_pairpi(h);abc++){
            ...
            if(B!=C){
              ...
              rel_left   = TIJABMatTmp->get_left()->get_tuple_index(K,J,C);
              vec_length = TIJABMatTmp->get_right_pairpi(sym_left);
              sym_right  = WAbiCMatTmp->get_left()->get_tuple_irrep(B,a,i);
              rel_right  = WAbiCMatTmp->get_left()->get_tuple_index(B,a,i);
              if(vec_length>0){
              ...
              rel_left   = TJiBaMatTmp->get_left()->get_tuple_index(J,i,B);
              vec_length = TJiBaMatTmp->get_right_pairpi(sym_left);
              sym_right  = WaBIcMatTmp->get_left()->get_tuple_irrep(a,C,K);
              rel_right  = WaBIcMatTmp->get_left()->get_tuple_index(a,C,K);
              if(vec_length>0){
                value = F_DDOT(&vec_length,&(TJiBa_matrix[sym_left][rel_left][0]),&incx,&(WaBIc_matrix[sym_right][rel_right][0]),&incy);
              ...
              rel_left   = TIABJMatTmp->get_left()->get_tuple_index(K,C,B);
              vec_length = TIABJMatTmp->get_right_pairpi(sym_left);
              sym_right  = WaJkIMatTmp->get_left()->get_tuple_irrep(a,J,i);
              rel_right  = WaJkIMatTmp->get_left()->get_tuple_index(a,J,i);
              if(vec_length>0){
              ...
              rel_left   = TiBaJMatTmp->get_left()->get_tuple_index(i,B,a);
              vec_length = TiBaJMatTmp->get_right_pairpi(sym_left);
              sym_right  = WAJKIMatTmp->get_left()->get_tuple_irrep(C,J,K);
              rel_right  = WAJKIMatTmp->get_left()->get_tuple_index(C,J,K);
              if(vec_length>0){
              ...
              rel_left   = TJaBiMatTmp->get_left()->get_tuple_index(K,a,B);
              vec_length = TJaBiMatTmp->get_right_pairpi(sym_left);
              sym_right  = WAjKiMatTmp->get_left()->get_tuple_irrep(C,i,J);
              rel_right  = WAjKiMatTmp->get_left()->get_tuple_index(C,i,J);
              if(vec_length>0){
                value = F_DDOT(&vec_length,&(TJaBi_matrix[sym_left][rel_left][0]),&incx,&(WAjKi_matrix[sym_right][rel_right][0]),&incy);
                MatTmp->add_six_address_element_Pjk_Pbc(i,J,K,a,B,C,value);
              }
