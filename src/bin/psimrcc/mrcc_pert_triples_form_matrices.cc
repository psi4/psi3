...
void CCMRCC::form_T2_ij_a_b(IndexMatrix* T2_ij_a_b,bool spin1,bool spin2,bool transpose)
{
...
void CCMRCC::form_T2_i_ab_j(IndexMatrix* T2_i_ab_j,bool spin1,bool spin2,bool transpose)
{
...
void CCMRCC::form_V_k_bc_e(IndexMatrix* V_k_bc_e,double direct,double exchange)
{
  // Build the matrices
...
void CCMRCC::form_V_jk_c_m(IndexMatrix* V_jk_c_m,double direct,double exchange)
{
  CCIndex* o   = blas->get_index("[o]");
  CCIndex* v   = blas->get_index("[v]");
  CCIndex* oo  = blas->get_index("[oo]");
