    ...
    for(int h =0; h < moinfo->get_nirreps();h++){
      ...
      for(int abc = 0;abc<TijkabcMatTmp->get_right_pairpi(h);abc++){
        ...
        for(int ijk = 0;ijk<TijkabcMatTmp->get_left_pairpi(h);ijk++){
          ...
          int ij = oo_indexing->get_tuple_index(i,j);
          int m  = o_indexing ->get_tuple_index(k);
    ...
    for(int h =0; h < moinfo->get_nirreps();h++){
      ...
      for(int abc = 0;abc<TijKabCMatTmp->get_right_pairpi(h);abc++){
        ...
        for(int ijk = 0;ijk<TijKabCMatTmp->get_left_pairpi(h);ijk++){
          ...
          int j = ooo_tuples[ooo_offset + ijk][1];
          int k = ooo_tuples[ooo_offset + ijk][2];
          int ik = oo_indexing->get_tuple_index(i,k);
          int m  = o_indexing ->get_tuple_index(j);
    ...
    for(int h =0; h < moinfo->get_nirreps();h++){
      ...
      for(int abc = 0;abc<TiJKaBCMatTmp->get_right_pairpi(h);abc++){
        ...
        for(int ijk = 0;ijk<TiJKaBCMatTmp->get_left_pairpi(h);ijk++){
          ...
          int j = ooo_tuples[ooo_offset + ijk][1];
          int k = ooo_tuples[ooo_offset + ijk][2];
          int jk = oo_indexing->get_tuple_index(j,k);
          int m  = o_indexing ->get_tuple_index(i);
    ...
    for(int h =0; h < moinfo->get_nirreps();h++){
      ...
      for(int ijk = 0;ijk<TijkabcMatTmp->get_left_pairpi(h);ijk++){
        ...
        for(int abc = 0;abc<TijkabcMatTmp->get_right_pairpi(h);abc++){
          ...
          int ab = vv_indexing->get_tuple_index(a,b);
          int e  = v_indexing ->get_tuple_index(c);
    ...
    for(int h =0; h < moinfo->get_nirreps();h++){
      ...
      for(int ijk = 0;ijk<TijKabCMatTmp->get_left_pairpi(h);ijk++){
        ...
        for(int abc = 0;abc<TijKabCMatTmp->get_right_pairpi(h);abc++){
          ...
          int b = vvv_tuples[vvv_offset + abc][1];
          int c = vvv_tuples[vvv_offset + abc][2];
          int ac = vv_indexing->get_tuple_index(a,c);
          int e  = v_indexing ->get_tuple_index(b);
    ...
    for(int h =0; h < moinfo->get_nirreps();h++){
      ...
      for(int ijk = 0;ijk<TiJKaBCMatTmp->get_left_pairpi(h);ijk++){
        ...
        for(int abc = 0;abc<TiJKaBCMatTmp->get_right_pairpi(h);abc++){
          ...
          int b = vvv_tuples[vvv_offset + abc][1];
          int c = vvv_tuples[vvv_offset + abc][2];
          int bc = vv_indexing->get_tuple_index(b,c);
          int e  = v_indexing ->get_tuple_index(a);
