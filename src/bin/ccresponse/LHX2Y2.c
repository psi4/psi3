...
double LHX2Y2(char *cart_x, int irrep_x, double omega_x, char *cart_y, int irrep_y, double omega_y)
{
  ...
  sprintf(lbl, "Z_%1s_MbeJ (Me,Jb)", cart_y);
  ...
  sprintf(lbl, "X_%1s_(2IAjb-jAIb) (%5.3f)", cart_y, omega_y);
  dpd_buf4_init(&Y2, CC_LR, irrep_y, 10, 10, 10, 10, 0, lbl);
  ...
  sprintf(lbl, "Z_%1s_(2MbEj+MbeJ) (ME,JB)", cart_y);
  ...
  sprintf(lbl, "X_%1s_(2IAjb-IbjA) (%5.3f)", cart_x, omega_x);
  ...
  sprintf(lbl, "Z_%1s_MbeJ (Me,Jb)", cart_y);
  dpd_buf4_init(&Z, CC_TMP0, irrep_y, 10, 10, 10, 10, 0, lbl);
  sprintf(lbl, "X_%1s_IbjA (%5.3f)", cart_x, omega_x);
  dpd_buf4_init(&X2, CC_LR, irrep_x, 10, 10, 10, 10, 0, lbl);
  ...
  sprintf(lbl, "X_%1s_IjAb (%5.3f)", cart_x, omega_x);
