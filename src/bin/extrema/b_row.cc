...
double *B_row_bond( int atom1, int atom2 ) {
...
double *B_row_angle( int atom1, int atom3, int atom2 ) {
...
double *B_row_tors( int atom1, int atom2, int atom3, int atom4 ) {
...
inline double *unit_vector( int atom1, int atom2 ) {
  ...
  for(i=0;i<3;++i) {
      unit_vec[i] = (cart_geom[atom2][i]-cart_geom[atom1][i]) / vec_norm(atom1,atom2);
    }
