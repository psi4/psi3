...
** Alpha eigenvalues used for occupied SOCC (sigma+), beta for unoccupied (sigma-)
...
void zapt_shift(double *TEI, int nirreps, int nmo, int *doccpi, int *soccpi, int *orbspi, int *frzdoccpi, int *reorder)
{
    int h1, h2;
    int x, y, i, j;
    int offset, offset2;
