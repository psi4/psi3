			       ...
			       int num_pq, int print_flag, FILE *outfile)
{
  ...
  case 11: /* No change in pq or rs; antisymmetrize */
	  ...
	  /* Fill the buffer */
	  dpd_file_mat_irrep_row_rd(&(Buf->file), irrep, pq+start_pq);
      ...
      /* Printing doesn't work for this function yet */
  ...
  case 12: /* no change in pq or rs */
      ...
      dpd_file_mat_irrep_rd_block(&(Buf->file), irrep, start_pq, num_pq,
				  print_flag, outfile);
  ...
  case 21: /* unpack pq; no change in rs */
      ...
      /* no printing yet for this function */
      if(0) dpd_buf_mat_irrep_print(Buf, irrep, outfile);
