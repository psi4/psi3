...
* These arguments mimic their Fortran conterparts; parameters have been reversed
* nca, ncb, ncc, A, B, C,  to make it correct for C.
...
\param int ncc:     On entry, the second dimension  of array C; ncc >=MAX(1,n)
