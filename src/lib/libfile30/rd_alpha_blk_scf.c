...
/*!
**  file30_rd_alpha_blk_scf():  Reads in a symmetry block of the alpha  SCF eigenvector 
**   (or whatever is stored in its place).
**  
**   \param int irrep:   designates the particular irrep to which the block
**     belongs.
**  
