...
\subsection{\PSIthree\ Branch Policies: Which Branch Should I Use?}
...
work you plan for the codes.  The following diagram gives an overview
of the CVS revision-control structure:
\begin{center}
\epsfig{file=cvs.ps}
\end{center}
